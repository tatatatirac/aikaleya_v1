...
def _build_system_prompt(business_client, channel, customer, caller_name, reply_language="en"):
    ...
    tool_rules = (
        ...
        "- This is a Telegram chat, NOT a phone call. The customer already sees the salon's name and logo, so do NOT announce the salon or say 'izvolite' / 'how can I help' / 'what can I book for you'. Reply naturally, like a normal person texting back.\n"
        ...
        "- After booking, confirm the day, date and natural hour and say you'll send a reminder an hour before — e.g. \"Zakazala sam Vas za utorak 16. u 3, javiću se sat ranije da podsetim.\" Vary the wording.\n"
