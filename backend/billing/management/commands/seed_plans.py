...
PLAN_CATALOG = [
    {
        ...
        "description": "1 staff member. WhatsApp + Telegram booking. Perfect for solo pros.",
        "features": [
            "AI receptionist (Kaleya)",
            "1 staff member",
            "WhatsApp booking",
            "Telegram booking (free channel)",
    ...
    },
    {
        ...
        "description": "Up to 5 staff. WhatsApp, SMS, and AI voice calls (US/CA).",
        "features": [
            "Everything in Starter",
            "Up to 5 staff members",
            "Voice calls — Kaleya answers your phone (US/CA only)",
            "SMS + Instagram DM + TikTok DM",
            "Automated reminders + spoken staff alarm",
