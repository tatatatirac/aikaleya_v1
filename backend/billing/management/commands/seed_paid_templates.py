...
TEMPLATE_CLIENTS = [
    {
        ...
        "staff": [],
        "services": [
            {"name": "Haircut", "category": "Salon", "duration": 30, "price": 25},
            {"name": "Coloring", "category": "Salon", "duration": 60, "price": 45},
            {"name": "Blowout", "category": "Salon", "duration": 30, "price": 30},
        ],
        "integrations": ("whatsapp", "viber", "telegram"),
    },
    {
        "email": "business-template@aikaleya.com",
        "company": "Kaleya Business Company",
        ...
        "services": [
            {"name": "Consultation", "category": "Services", "duration": 30, "price": 45},
            {"name": "Treatment", "category": "Services", "duration": 60, "price": 90},
            {"name": "Follow-up", "category": "Services", "duration": 30, "price": 35},
        ],
    ...
    },
    {
        ...
        "services": [
            {"name": "Premium Consultation", "category": "Premium", "duration": 30, "price": 75},
            {"name": "Premium Treatment", "category": "Premium", "duration": 60, "price": 140},
            {"name": "Extended Session", "category": "Premium", "duration": 120, "price": 240},
            {"name": "Follow-up", "category": "Premium", "duration": 30, "price": 50},
        ],
