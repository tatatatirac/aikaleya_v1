const PAGE_LANGS = {
    sr: {
        ...
        reg_badge: 'Besplatnih 14 dana',
        reg_title: 'Počni besplatno —',
        reg_lead: '14 dana besplatno. Otkaži pre roka i ne plaćaš ništa.',
        company: 'Naziv firme',
        name: 'Ime i prezime',
        email: 'Email',
        password: 'Lozinka',
        ...
        payment_note: 'Sigurna naplata — LemonSqueezy. Podaci kartice se nikad ne čuvaju na našim serverima.',
    ...
    en: {
        ...
        reg_badge: 'Free 14-day trial',
        reg_title: 'Start your free trial —',
        reg_lead: '14-day free trial. Cancel before day 14 and pay nothing.',
        ...
        payment_note: 'Secure checkout — LemonSqueezy. Your card details are never stored on our servers.',
    ...
    es: {
        ...
        reg_badge: 'Prueba gratuita 14 días',
        reg_title: 'Empieza gratis —',
        reg_lead: '14 días de prueba gratuita. Cancela antes del día 14 y no pagas nada.',
        company: 'Empresa',
        ...
        payment_note: 'Pago seguro — LemonSqueezy. Tus datos de tarjeta nunca se almacenan en nuestros servidores.',
        god_badge: 'Buy All',
    ...
    pt: {
        ...
        reg_badge: 'Teste gratuito de 14 dias',
        reg_title: 'Comece grátis —',
        reg_lead: '14 dias de teste gratuito. Cancele antes do dia 14 e não paga nada.',
        company: 'Empresa',
        name: 'Nome completo',
        email: 'Email',
        password: 'Senha',
        ...
        payment_note: 'Checkout seguro — LemonSqueezy. Seus dados de cartão nunca são armazenados em nossos servidores.',
        god_badge: 'Buy All',
    ...
    ru: {
        ...
        reg_badge: 'Бесплатно 14 дней',
        reg_title: 'Начните бесплатно —',
        reg_lead: '14 дней бесплатно. Отмените до 14-го дня — и вы ничего не платите.',
        company: 'Компания',
        name: 'Имя и фамилия',
        email: 'Email',
        password: 'Пароль',
        ...
        payment_note: 'Безопасная оплата — LemonSqueezy. Данные карты никогда не хранятся на наших серверах.',
        god_badge: 'Buy All',
...
PAGE_LANGS.fr = {
    ...
    reg_badge: 'Essai gratuit 14 jours',
    reg_title: 'Commencez gratuitement —',
    reg_lead: '14 jours d essai gratuit. Annulez avant le 14e jour et vous ne payez rien.',
    ...
    payment_note: 'Paiement securise — LemonSqueezy. Vos donnees de carte ne sont jamais stockees sur nos serveurs.',
...
PAGE_LANGS.it = {
    ...
    reg_badge: 'Prova gratuita 14 giorni',
    reg_title: 'Inizia gratuitamente —',
    reg_lead: '14 giorni di prova gratuita. Cancella entro il 14° giorno e non paghi nulla.',
    ...
    payment_note: 'Pagamento sicuro — LemonSqueezy. I dati della carta non vengono mai memorizzati sui nostri server.',
...
PAGE_LANGS.de = {
    ...
    reg_badge: 'Kostenlos 14 Tage',
    reg_title: 'Kostenlos starten —',
    reg_lead: '14 Tage kostenlos testen. Kuendige vor Tag 14 und du zahlst nichts.',
    company: 'Firmenname',
    ...
    payment_note: 'Sichere Zahlung — LemonSqueezy. Deine Kartendaten werden nie auf unseren Servern gespeichert.',
    god_badge: 'Buy All',
    god_title: 'GOD MODE Paket',
...
const PAGE_LEGAL = {
    privacy: {
        sr: [
            ['Podaci koje prikupljamo', 'Prikupljamo podatke koje nam direktno dajete: naziv firme, ime kontakt osobe, email adresu, broj telefona, lozinku i državu prilikom registracije. Prikupljamo i podatke o korišćenju (posećene stranice, korišćene funkcije, vreme sesija), tehničke podatke (IP adresa, tip pregledača, identifikatori uređaja) i podatke o naplati koje obrađuje naš payment provajder. Zapisi glasovnih i AI interakcija mogu se čuvati radi poboljšanja kvaliteta usluge i u svrhu revizije.'],
            ['Kako koristimo vaše podatke', 'Vaše podatke koristimo da: kreiramo i vodimo vaš nalog; pružamo i unapređujemo Kaleya uslugu; obrađujemo plaćanja i šaljemo obaveštenja o naplati; šaljemo servisna obaveštenja i odgovore podrške; otkrivamo prevare i održavamo bezbednost platforme; ispunjavamo zakonske obaveze. Ne prodajemo vaše lične podatke trećim stranama.'],
            ['Usluge trećih strana', 'Kaleya koristi sledeće obrađivače podataka koji mogu obrađivati vaše podatke: (1) Anthropic — obrada putem AI jezičkog modela (vaše poruke se šalju Anthropic API-ju radi generisanja odgovora); (2) ElevenLabs — sinteza glasa za AI odgovore; (3) Lemon Squeezy — obrada plaćanja i upravljanje pretplatom (deluje kao Merchant of Record); (4) Sentry — praćenje grešaka i dijagnostika. Svaki obrađivač je vezan sopstvenim ugovorima o obradi podataka i politikama privatnosti.'],
            ['Kolačići i praćenje', 'Kaleya koristi neophodne kolačiće za prijavu (token sesije) i čuvanje podešavanja (jezik, tema). Ako izaberete „Prihvati sve“, možemo koristiti i analitičke kolačiće. Svoje podešavanje kolačića možete promeniti u bilo kom trenutku pomoću trake na dnu ove stranice. Ne koristimo reklamne kolačiće niti praćenje između sajtova.'],
            ['Zadržavanje podataka', 'Podatke vašeg naloga čuvamo dok je pretplata aktivna, plus do 30 dana nakon otkazivanja radi mogućnosti vraćanja naloga. Nakon tog perioda, lični podaci se trajno brišu. Podaci o naplati mogu se čuvati do 7 godina u skladu sa zakonom. Trenutno brisanje možete zatražiti slanjem zahteva za brisanje naloga sa vašeg dashboard-a.'],
            ['Vaša prava (GDPR i CCPA)', 'U zavisnosti od vaše lokacije, imate pravo da: pristupite kopiji svojih ličnih podataka (koristite funkciju Izvoz na dashboard-u); ispravite netačne podatke; zatražite brisanje podataka; uložite prigovor ili ograničite određenu obradu; prenesete podatke. Stanovnici Kalifornije imaju dodatno pravo da znaju koji se lični podaci prodaju ili otkrivaju (mi ne prodajemo lične podatke). Za ostvarivanje bilo kog prava, pišite na hello@aikaleya.com. Odgovaramo u roku od 30 dana.'],
            ['Bezbednost podataka', 'Koristimo standardne zaštitne mere: HTTPS/TLS šifrovanje u prenosu, heširane lozinke, httpOnly tokene za prijavu i čuvanje tajni na serverskoj strani. API ključevi se nikada ne izlažu u frontend kodu. Uprkos ovim merama, nijedan sistem nije potpuno bezbedan. Preporučujemo da koristite jaku, jedinstvenu lozinku.'],
            ['Deca', 'Kaleya je poslovna usluga namenjena korisnicima starijim od 18 godina. Ne prikupljamo svesno lične podatke dece mlađe od 13 godina.'],
            ['Izmene ove politike', 'Možemo ažurirati ovu Politiku privatnosti. Kada to uradimo, ažuriraćemo datum na vrhu i obavestiti aktivne korisnike emailom. Nastavak korišćenja usluge nakon izmena znači prihvatanje.'],
            ['Kontakt', 'Za pitanja o privatnosti, zahteve za podatke ili nedoumice: hello@aikaleya.com · aikaleya.com. Ova politika je poslednji put ažurirana u maju 2026. i treba da je proveri kvalifikovani pravnik pre komercijalnog lansiranja.']
        ],
        en: [
    ...
    terms: {
        sr: [
            ['Opis usluge', 'Kaleya („Usluga“, „mi“, „nas“) je pretplatnička AI platforma — recepcionar koja automatizuje zakazivanje termina, glasovne odgovore, komunikaciju sa klijentima i poslovna obaveštenja. Uslugom upravlja Kaleya AI (aikaleya.com). Kreiranjem naloga prihvatate ove Uslove korišćenja.'],
            ['Uslovi naloga i pristup', 'Morate imati najmanje 18 godina i biti ovlašćeni da sklapate ugovore u ime svoje firme da biste koristili Kaleyu. Odgovorni ste za: davanje tačnih podataka pri registraciji; čuvanje poverljivosti svojih podataka za prijavu; sve aktivnosti na vašem nalogu; usklađenost korišćenja usluge sa važećim zakonima. Odmah nas obavestite na hello@aikaleya.com ako sumnjate na neovlašćeni pristup.'],
            ['Pretplata, naplata i otkazivanje', 'Kaleya nudi plaćene pretplatničke pakete sa besplatnim probnim periodom. Plaćanje obrađuje Lemon Squeezy (Merchant of Record — oni obrađuju porez, PDV i račune). Vaša pretplata se automatski obnavlja na kraju svakog obračunskog perioda osim ako je otkažete. Možete otkazati u bilo kom trenutku sa svog dashboard-a; pristup traje do kraja tekućeg perioda. Povraćaj sredstava se odobrava po našoj proceni u izuzetnim slučajevima — obratite se podršci u roku od 7 dana od naplate. Cene se mogu promeniti uz obaveštenje 30 dana unapred aktivnim pretplatnicima.'],
            ['Prihvatljiva upotreba', 'Saglasni ste da nećete: koristiti uslugu u nezakonite, prevarne ili štetne svrhe; lažno se predstavljati kao druga osoba ili entitet; pokušavati reverzni inženjering, skrejpovanje ili preopterećenje platforme; koristiti AI za generisanje spama, obmanjujućeg sadržaja ili sadržaja koji krši prava trećih strana; preprodavati ili podlicencirati uslugu bez pisane dozvole. Zadržavamo pravo da suspendujemo ili ukinemo naloge koji krše ove uslove, bez povraćaja sredstava.'],
            ['AI usluga i ograničenja', 'Kaleyin AI pokreću jezički modeli trećih strana (Anthropic Claude). AI odgovori se generišu automatski i povremeno mogu biti netačni, nepotpuni ili neprikladni za datu situaciju. Kaleya ne garantuje da će AI ispravno završiti svaki zahtev. Vi ste odgovorni da pregledate komunikaciju koju generiše AI pre nego što se na nju oslonite za važne poslovne odluke. Kada AI ne može da reši zahtev, može ga proslediti ljudskoj podršci.'],
            ['Podaci i privatnost', 'Vaše korišćenje usluge uređeno je našom Politikom privatnosti (aikaleya.com/privacy). Korišćenjem usluge pristajete na prakse obrade podataka opisane tamo. Zadržavate vlasništvo nad svojim poslovnim podacima. Dajete Kaleyi ograničenu licencu da obrađuje vaše podatke isključivo radi pružanja usluge.'],
            ['Intelektualna svojina', 'Kaleya, njen logo, dizajn platforme i softver u pozadini vlasništvo su Kaleya AI. Ne smete kopirati, menjati ili distribuirati bilo koji deo usluge bez izričite pisane dozvole. Zadržavate puno vlasništvo nad svojim sadržajem, podacima mušterija i podešavanjima.'],
            ['Odricanje od garancija', 'Usluga se pruža „takva kakva jeste“ i „kako je dostupna“, bez garancija bilo koje vrste, izričitih ili podrazumevanih, uključujući ali ne ograničavajući se na utrživost, podobnost za određenu svrhu ili neprekidan rad. Ne garantujemo da će usluga biti bez grešaka niti da će AI odgovori uvek biti tačni.'],
            ['Ograničenje odgovornosti', 'U najvećoj meri dozvoljenoj zakonom, Kaleya AI neće biti odgovorna za indirektnu, slučajnu, posebnu, posledičnu ili kaznenu štetu, uključujući izgubljenu dobit ili podatke, koja proističe iz vašeg korišćenja ili nemogućnosti korišćenja usluge. Naša ukupna odgovornost prema vama za bilo koji zahtev neće preći iznos koji ste platili za uslugu u 3 meseca pre zahteva.'],
            ['Merodavno pravo', 'Ove Uslove uređuju zakoni države Delaver, Sjedinjene Američke Države, bez obzira na principe sukoba zakona. Svi sporovi rešavaju se obavezujućom arbitražom po AAA pravilima, osim što svaka strana može tražiti privremenu meru pred nadležnim sudom.'],
            ['Izmene uslova', 'Možemo ažurirati ove Uslove. Aktivne pretplatnike ćemo obavestiti emailom najmanje 14 dana pre nego što značajne izmene stupe na snagu. Nastavak korišćenja usluge nakon datuma stupanja na snagu znači prihvatanje. Ako se ne slažete sa ažuriranim Uslovima, možete otkazati pretplatu pre nego što stupe na snagu.'],
            ['Kontakt', 'Pitanja o ovim Uslovima: hello@aikaleya.com · aikaleya.com. Ovi Uslovi su poslednji put ažurirani u maju 2026. i treba da ih proveri kvalifikovani pravnik pre komercijalnog lansiranja.']
        ],
        en: [
...
const CHECKOUT_PLAN_DETAILS = {
    ...
    business_plus_yearly:{ name: 'Business+ — Yearly', price: '$5,790 / year', trial: '14 days' },
